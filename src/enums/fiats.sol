...
// TODO only currencies with Oracle feed available
enum Fiat {
    ...
    UZS, // Uzbekistani Soʻm (Uzbekistan)
    VES, // Venezuelan Bolívar Soberano (Venezuela)
    VND, // Vietnamese Đồng (Vietnam)
    VUV, // Vanuatu Vatu (Vanuatu)
    WST, // Samoan Tālā (Samoa)
    XAF, // Central African CFA Franc (Central African Republic, Chad, Cameroon, Congo Republic, Equatorial Guinea, Gabon)
    XCD, // East Caribbean Dollar (Antigua and Barbuda, Dominica, Grenada, Saint Kitts and Nevis, Saint Lucia, Saint Vincent and the Grenadines)
