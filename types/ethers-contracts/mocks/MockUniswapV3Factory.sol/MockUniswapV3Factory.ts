...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface MockUniswapV3FactoryInterface extends Interface {
    getFunction(nameOrSignature: "getPool" | "pools" | "setPool"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'setPool', values: [AddressLike, AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'setPool', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    setPool: TypedContractMethod<
      [tokenA: AddressLike, pool: AddressLike, ],
      [void],
      'nonpayable'
    >
